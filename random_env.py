...
env.seed(2)
env.generate_environment(0,[8, 32, 64])
...
np.savez("results/random_results.npz", random_score_array=random_score_array, random_utilization_array=random_utilization_array)